        ...
        <>
            <Link to={`/product/${id}`} className='text-gray cursor-pointer pb-10 '>
                ...
                <div className='relative '>
                    <div className='absolute bg-red-600 rounded-full w-8 justify-center text-center align-middle items-center h-8 -top-6 right-0 m-2 opacity-100 hover:bg-red-700 transition-opacity'>
